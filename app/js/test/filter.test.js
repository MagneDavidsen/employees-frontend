...
describe("when filtering spots", function() {
  it("it only returns the spots that match the filters", function() {
  ...
  it("no active filters means all spots are returned", function() {
    var activeFilters = [];
  ...
  it("only spots from the selected city should be returned", function() {
    var activeFilters = [];
  ...
  it("only spots from the selected city that matches the filter should be returned", function() {
    var activeFilters = ["Bar"];
